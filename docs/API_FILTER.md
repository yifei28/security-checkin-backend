...
| `heightMin` | int | 最低身高(cm) | `170` |
| `heightMax` | int | 最高身高(cm) | `180` |
| `firefightingCertMin` | int | 消防证最低级别 | `1-5` |
| `firefightingCertMax` | int | 消防证最高级别 | `1-5` |
| `securityGuardCertMin` | int | 保安师证最低级别 | `1-5` |
| `securityGuardCertMax` | int | 保安师证最高级别 | `1-5` |
...
// 筛选身高170cm以上的保安
GET /api/guards?heightMin=170

// 筛选身高170-180cm的保安
GET /api/guards?heightMin=170&heightMax=180
...
- **2026-01-01**: 新增证书筛选参数（消防证、保安师证、安检证）
